...
namespace BaseMod
{
	/*public class BaseInvasion
	{
		...
		public virBaseModl int GetMusic()
		{
			return -1;
		}

		public virBaseModl void BeginInvasion(bool dev = false){}

		public virBaseModl void EndInvasion(bool defeated, string chat, Color chatColor){}

		public virBaseModl int GetDCValue(NPC npc)
		{				
			return 1;
		}

		public virBaseModl void SetDCMax(){}

		public virBaseModl void SpawnRate(ref int spawnRate, ref int maxSpawns)
		{
			int activePlayers = 0;
