...
namespace BaseMod
{
    public class BaseWorldGen
    {
		 ...
		 *  Note that (endX, endY) is NOT the acBaseModl end of the hallway, but the end of the inner wall.
		 *  
		 ...
		 *  Note that (endX, endY) is NOT the acBaseModl end of the room, but the end of the inner wall.
		 *  
