...
namespace BaseMod
{
    public class BaseAI
    {
		...
		*/
         ...
         * chainDistance : How far for the flail to acBaseModlly go.
         */
         ...
         *  damager : The thing acBaseModlly doing damage (Player, Projectile, NPC or null)
         ...
         *  knockback : The amount of knockback to inflict.
         *  hitDirection : The direction of the damage.
         *  damager : the thing acBaseModlly doing damage (Player, Projectile or null)
         *  dmgVariation : If true, the damage will vary based on Main.DamageVar().
         ...
         * Can be used in Kill() methods to acBaseModlly kill the projectile while you spawn other things like dust.
         */
