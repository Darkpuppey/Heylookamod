...
{
	public class VulcaniteThrasherP : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(target.Center, projectile.velocity * 0.01f, mod.ProjectileType("JimShard"), damage / 2, 5, Main.myPlayer, 0, 0);
			Projectile.NewProjectile(target.Center, projectile.velocity * 0, mod.ProjectileType("JimExplosion"), damage, 5, Main.myPlayer, 0, 0);
		}
	}
}
